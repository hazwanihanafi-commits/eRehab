...
export default function App() {
  ...
  const addSession = () => {
    setSessions([
      ...sessions,
      { type: "Robotik", start: "", end: "", duration: "" }
    ]);
  };
  ...
  const updateSession = (i, field, value) => {
    ...
    newS[i].duration = calculateDuration(newS[i].start, newS[i].end);
  ...
  const submit = async () => {
    ...
    if (!verified) return alert("Verification required");
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-6">
        ...
        {page === "patients" && (
          <div>
            ...
            {data
              ...
              .map((x, i) => (
                <div key={i} className="card flex justify-between mb-2">
        ...
        {page === "detail" && (
          <div>
            ...
            <button onClick={() => setPage("patients")} className="mb-3">
              ← Back
            </button>
        ...
        {page === "entry" && (
          <div className="card">
            ...
            <label><input type="checkbox" onChange={() => setConsent(!consent)} /> Consent</label>
            <label><input type="checkbox" onChange={() => setVerified(!verified)} /> Verified</label>
      ...
      {/* PDF TEMPLATE */}
      <div id="report" className="hidden p-10 bg-white">
